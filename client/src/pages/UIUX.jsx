        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Premium design experiences that delight users and drive engagement.
              Human-centered design for enterprise applications.
            </p>
          </div>
        </div>
      </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { title: 'User Research', desc: 'Interviews, surveys, usability testing' },
              { title: 'Wireframing', desc: 'Low-fidelity prototypes and user flows' },
              { title: 'Visual Design', desc: 'High-fidelity UI with modern aesthetics' },
