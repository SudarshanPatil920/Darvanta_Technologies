        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700 ease-out">
            ...
            <p className="text-xl text-gray-600 max-w-3xl">
              Native and cross-platform mobile apps for iOS and Android. Premium user experiences 
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { title: 'React Native', desc: 'Cross-platform apps with native performance' },
              { title: 'iOS Native', desc: 'Swift/Objective-C for Apple ecosystem' },
              { title: 'Android Native', desc: 'Kotlin/Java for Google platform' },
              { title: 'Flutter', desc: 'Beautiful UI with single codebase' }
            ].map((item, i) => (
