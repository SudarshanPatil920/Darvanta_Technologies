      ...
      <nav className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            {/* Live Project Button */}
            <a
              href="https://dev.darvantatech.com/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-sm font-medium text-[#0A5C4E] hover:text-[#0a4c40] transition-colors border border-[#0A5C4E] px-4 py-2 rounded-md hover:bg-[#0A5C4E]/5"
            >
              Live Projects
            </a>
        ...
        <div className={cn(
          ...
          <div className="px-6 py-6 space-y-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block py-2 text-base font-medium text-[#0A5C4E] hover:text-[#0a4c40] border border-[#0A5C4E] text-center px-4 py-2 rounded-md hover:bg-[#0A5C4E]/5"
              onClick={() => setMobileMenuOpen(false)}
            >
              Live Projects
            </a>
